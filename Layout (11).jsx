              ...
              {profileOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-12 z-50 w-60 rounded-xl p-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-1">
                    ...
                    <a
                      href="/teacher.html"
                      className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-medium text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-colors text-left no-underline"
                    >
                      <BookOpen size={15} />
