  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">O'quv markazidagi barcha kurslar o'zlashtirish va daromad ko'rsatkichlari</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">O'qituvchilarning retensiya, baholash va yuklama tahlili</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Kassa va bank hisobvaraqlaridagi kirim-chiqimlar harakati</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Barcha o'qituvchi va xodimlarning maosh va KPI bonuslari</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">O'quvchilarga berilgan barcha chegirmalar va ularning moliyaviy ta'siri</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Tizim orqali yuborilgan barcha avto va qo'lda SMS xabarlar statistikasi</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Xodimlarning kelib-ketish vaqtlari va ish soatlari tahlili</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Guruhlar jurnali to'ldirilishi, dars mavzulari va uy vazifasi nazorati</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Talabalar gamifikatsiya coinlari, ishlatilgan sovg'alar va reyting tahlili</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Talabalarning test va imtihon ballari va umumiy reyting natijalari</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">O'tkazilgan imtihonlar, Mock testlar va sertifikatlash ko'rsatkichlari</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Reklama kanallari samadorligi va sotuv voronkasi (Funnel) hisoboti</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">O'quvni to'xtatgan talabalar, ketish sabablari va pul qaytarish tarixi</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Darslarni qoldirish sabablari va umumiy davomat ko'rsatkichlari</p>
      </div>
