  ...
  return (
    ...
    >
      <div className="space-y-4 text-slate-900 dark:text-slate-100">
        ...
        {/* 3. Narxi va davomiyligi */}
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className={LABEL_CLS}>3. Oylik narxi (so'm)</label>
            <MoneyInput
              value={price}
        ...
        {/* 4. O'qituvchi va kelishuv */}
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/60 p-3.5 space-y-3">
          <label className={`${LABEL_CLS} text-indigo-600 dark:text-indigo-400 font-bold`}>
            4. O'qituvchi va ish haqi kelishuvi
          </label>
          
          <div>
            <label className={LABEL_CLS}>O'qituvchi</label>
            <select
              value={teacherId}
          ...
          {selectedTeacher && (
            <div className="grid grid-cols-2 gap-3 pt-1 border-t border-slate-200/80 dark:border-slate-800">
              <div>
        ...
        {/* 5. Xona va Dars kunlari */}
        <div className="space-y-3 rounded-xl border border-slate-200 dark:border-slate-800 p-3.5 bg-white dark:bg-slate-900/40">
          {rooms && rooms.length > 0 && (
            <div>
              <label className={LABEL_CLS}>5. Xona (ixtiyoriy)</label>
              <select
                value={roomId}
          ...
          <div>
            <label className={`${LABEL_CLS} mb-2 block`}>
              Dars kunlari <span className="text-[11px] font-normal text-slate-500">(Tanlanganda rang bilan yaqqol ajralib turadi)</span>
            </label>
            <DayPicker value={days} onChange={setDays} />
          </div>
        </div>

        {/* 6. Dars vaqti va dars davomiyligi vaqti */}
        <div className="grid grid-cols-2 gap-3">
          <div>
