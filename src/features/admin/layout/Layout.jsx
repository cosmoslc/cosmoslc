...
export function AppShell({
  ...
  // Accordion state for sub-menus (closed by default, opened only on user click)
      ...
      <div className="app-body">
        ...
        >
          ...
          <ul className="nav-group" ref={navGroupRef}>
            ...
            {/* 5. OFIS BO'LIMI (SUBMENU) */}
            {canShowGroup(["branches", "positions", "managers", "rooms", "holidays", "receiptSettings"]) && (
              <li className={`nav-parent-wrapper ${pinnedFlyout === "office" ? "is-flyout-open" : ""}`}>
                <div
                  id="nav-parent-office"
                  onClick={() => toggleMenu("office")}
                  className={`nav-parent-item ${
                    openMenus.office || pinnedFlyout === "office" ? "is-open" : ""
                  } ${
                    ["branches", "positions", "managers", "rooms", "holidays", "receiptSettings"].includes(view)
                      ? "has-active-child"
                      : ""
                  }`}
                  title={collapsed ? "Ofis" : undefined}
                >
                  <span
                    className="ic"
                    style={{ color: NAV_ICON_COLORS.branches || "#e74c6f" }}
                  >
                    <Building2 size={18} />
                  </span>
            ...
            {/* 6. O'QUV BO'LIMI (SUBMENU) */}
            {canShowGroup(["courses", "reasons", "placementTest", "points", "examTemplates"]) && (
              <li className={`nav-parent-wrapper ${pinnedFlyout === "academic" ? "is-flyout-open" : ""}`}>
                <div
                  id="nav-parent-academic"
                  onClick={() => toggleMenu("academic")}
                  className={`nav-parent-item ${
                    openMenus.academic || pinnedFlyout === "academic" ? "is-open" : ""
                  } ${
                    ["courses", "reasons", "placementTest", "points", "examTemplates"].includes(view)
                      ? "has-active-child"
                      : ""
                  }`}
                  title={collapsed ? "O'quv" : undefined}
                >
                  <span
                    className="ic"
                    style={{ color: NAV_ICON_COLORS.courses || "#f97316" }}
                  >
                    <BookOpen size={18} />
                  </span>
                  <span className="label">O'quv</span>
                  <ChevronDown size={14} className="chev" />
                </div>
                {(openMenus.academic || collapsed) && (
                  <ul className="nav-sub-menu">
                    {collapsed && (
                      <li className="px-2 py-1 mb-1 border-b border-slate-100 dark:border-slate-800 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                        O'quv
                    ...
                    {isAllowed("placementTest") && (
                      <li>
                        <button
                          id="nav-sub-placementTest"
                    ...
                    {isAllowed("examTemplates") && (
                      <li>
                        <button
                          id="nav-sub-examTemplates"
            ...
            {/* 7. SOZLAMALAR BO'LIMI (SUBMENU) */}
            {canShowGroup(["centerSettings", "smsBuy", "autoSms", "smsTemplates", "simpleForm", "teacherForm", "staffForm", "referralForm", "tags", "paymentTypes"]) && (
              <li className={`nav-parent-wrapper ${pinnedFlyout === "settings" ? "is-flyout-open" : ""}`}>
                <div
                  ...
                  className={`nav-parent-item ${
                    ...
                    ["centerSettings", "smsBuy", "autoSms", "smsTemplates", "simpleForm", "teacherForm", "staffForm", "referralForm", "tags", "paymentTypes"].includes(view)
                      ? "has-active-child"
                      : ""
                  }`}
